...
obs <- read.table("qiime2/diversity/alpha_diversity/observed_features_vector/metadata.tsv", header = TRUE)
evenness <- read.table("qiime2/diversity/alpha_diversity/evenness_vector/metadata.tsv", header=TRUE)
shannon <- read.table("qiime2/diversity/alpha_diversity/shannon_vector/metadata.tsv", header = TRUE)
faith_pd <- read.table("qiime2/diversity/alpha_diversity/faith_pd_vector/metadata.tsv", header=TRUE)
