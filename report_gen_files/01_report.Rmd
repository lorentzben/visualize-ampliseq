...
# tax.clean[is.na(tax.clean[,1]),1] <- "Unidentified"
...
# tax.clean$Genus[i] <- paste("Genus",tax.clean$Genus[i], sep = "_")
# }
# }
...
cycle_1 <- phyloseq(new_table_ps, new_tax_ps, new_tree_ps, new_metadata)
