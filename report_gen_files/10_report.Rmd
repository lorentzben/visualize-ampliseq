...
#TODO check if we need to unzip this qza object
weighted_measurements <- read.csv(paste0("weighted_unifrac_distance_matrix-",ioi,"/raw_data.tsv"), sep="\t")
...
library(ggplot2)
unweighted_measurements <- read.csv(paste0("unweighted_unifrac_distance_matrix-",ioi,"/raw_data.tsv"), sep="\t")
