...
weighted_measurements <- read.csv(paste0("results/qiime2/diversity/beta_diversity/weighted_unifrac_distance_matrix-",ioi,"/raw_data.tsv"), sep="\t")
...
library(ggplot2)
unweighted_measurements <- read.csv(paste0("results/qiime2/diversity/beta_diversity/unweighted_unifrac_distance_matrix-",ioi,"/raw_data.tsv"), sep="\t")
