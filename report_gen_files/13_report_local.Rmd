...
library(gtools)
pwd <- getwd()
lefse_res_filenames <- list.files(paste0(pwd,"/lefse_images"),pattern="*_res.png",full.names = T)

lefse_filenames <- mixedsort(lefse_res_filenames)

print("The Lefse generated images are named:")
print(lefse_filenames)
print("these files can be found in result/lefse/lefse_images/*.png")
...
lefse_res_filenames <- list.files(paste0(pwd,"/lefse_images"),pattern="*_pdf_r.png",full.names=T)
...
lefse_clado_filenames <- list.files(paste0(pwd,"/lefse_images"),pattern="*_cladogram.png",full.names=T)
  
lefse_filenames <- mixedsort(lefse_clado_filenames)

print("The Lefse generated Cladograms are named:")
print(lefse_filenames)
print("these files can be found in result/lefse/lefse_images/*.png")
```