...
lefse_res_filenames <- list.files(pattern="*_res.png",full.names = T)
...
lefse_res_filenames <- list.files(pattern="*_pdf_r.png",full.names=T)
...
lefse_clado_filenames <- list.files(pattern="*_cladogram.png",full.names=T)
