...
lefse_res_filenames <- list.files("lefse_images",pattern="*_res.png",full.names = T)
...
lefse_clado_filenames <- list.files("lefse_images",pattern="*_cladogram.png",full.names=T)
