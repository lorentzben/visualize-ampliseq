...
#TODO update this tree with yes yes yes and no no no 
# if filtered table is provided:
# if (file.exists("filtered-table.tsv")){
#   # Yes SRS Yes NC Maybe Mock (comes from SRS directly)
#   new_table_file <- paste0("filtered-table.tsv")
#   new_table <- read.csv(new_table_file,sep='\t')
#   new_table_df <- data.frame(new_table)
#   new_table_df$"#NAME" <- rownames(new_table_df)
#   new_table_df <- new_table_df %>% select("#NAME", everything())
#   write.table(new_table_df,file = paste0(mbadir,"/ASV-tab.txt"),sep='\t',row.names = F)
# } else if(file.exists("mock-nc-removed.tsv") {
#   # No SRS possibly NC and possibly Mock (comes from qiime samples filter)
#   #TODO check by hand
#   new_table_file <- paste0("mock-nc-removed.tsv")
#   new_table <- read.csv(new_table_file,sep='\t')
#   new_table_df <- data.frame(new_table)
#   new_table_df$"#NAME" <- rownames(new_table_df)
#   new_table_df <- new_table_df %>% select("#NAME", everything())
...
# }
#  else {
#   # if not filtered (no-NC) no-Mock no-SRS:
...
new_table_df <- read_table('table.tsv', sep='\t')
new_table_df$"#NAME" <- rownames(new_table_df)
new_table_df <- new_table_df %>% select("#NAME", everything())
...
![Stacked Bar Plot of Relative Abundance Subsetted Phyla Over 10 count](barplots/taxa_alpha_merge_relative_Phylum.png)
![Stacked Bar Plot of Relative Abundance top 10 Phyla](barplots/taxa_alpha_subset_relative_Phylum.png)
![Stacked Bar Plot of Relative Abundance Merged Phyla Over 10 count](barplots/taxa_alpha_merge_absolute_Phylum.png)
![Stacked Bar Plot of Absolute Abundance top 10 Phyla](barplots/taxa_alpha_subset_absolute_Phylum.png)

![Stacked Bar Plot of Relative Abundance Merged Phyla over 10 Count Item of interest](barplots/taxa_alpha_merge_relative_ioi_Phylum.png)


![Stacked Bar Plot of Relative Abundance top 10 Phyla Merged Item of interest](barplots/taxa_alpha_subset_relative_ioi_Phylum.png)
...
![Stacked Bar Plot of Relative Abundance of Merged Genera Over 10 count](barplots/taxa_alpha_merge_relative_Genus.png)
![Stacked Bar Plot of Relative Abundance top 10 Genera](barplots/taxa_alpha_subset_relative_Genus.png)
![Stacked Bar Plot of Absolute Abundance of Merged Genera Over 10 count](barplots/taxa_alpha_merge_absolute_Genus.png)
![Stacked Bar Plot of Absolute Abundance top 10 Genera](barplots/taxa_alpha_subset_absolute_Genus.png)

![Stacked Bar Plot of Relative Abundance Merged Phyla over 10 Count Item of interest](barplots/taxa_alpha_merge_relative_ioi_Genus.png)

![Stacked Bar Plot of Relative Abundance top 10 Phyla Merged Item of interest](barplots/taxa_alpha_subset_relative_ioi_Genus.png)
...
![Stacked Bar Plot of Relative Abundance Subsetted Species Over 10 count](barplots/taxa_alpha_merge_relative_Species.png)
![Stacked Bar Plot of Relative Abundance top 10 Species](barplots/taxa_alpha_subset_relative_Species.png)
![Stacked bar plot absolute of merged Species with count less than 10 ](barplots/taxa_alpha_merge_absolute_Species.png)
![Stacked bar plot absolute of top 10 subsetted Species ](barplots/taxa_alpha_subset_absolute_Species.png)

![Stacked Bar Plot of Relative Abundance Merged Phyla over 10 Count Item of interest](barplots/taxa_alpha_merge_relative_ioi_Species.png)

![Stacked Bar Plot of Relative Abundance top 10 Phyla Merged Item of interest](barplots/taxa_alpha_subset_relative_ioi_Species.png)